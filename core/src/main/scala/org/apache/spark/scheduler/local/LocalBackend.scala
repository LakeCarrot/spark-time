...
private case class StatusUpdate(taskId: Long, state: TaskState, serializedData: ByteBuffer, time: Long, taskSize: Long, fetchSize: Long)
...
private[spark] class LocalEndpoint(
  ...
  override def receive: PartialFunction[Any, Unit] = {
    ...
    case StatusUpdate(taskId, state, serializedData, time, taskSize, fetchSize) =>
...
private[spark] class LocalBackend(
  ...
  override def statusUpdate(taskId: Long, state: TaskState, serializedData: ByteBuffer, time: Long, taskSize: Long, fetchSize: Long) {
    localEndpoint.send(StatusUpdate(taskId, state, serializedData,0,0,0))
  }
