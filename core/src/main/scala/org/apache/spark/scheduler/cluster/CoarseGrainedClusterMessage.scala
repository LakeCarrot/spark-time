...
private[spark] object CoarseGrainedClusterMessages {
  ...
  case class StatusUpdate(executorId: String, taskId: Long, state: TaskState,
    data: SerializableBuffer, time: Long, taskSize: Long, fetchSize: Long) extends CoarseGrainedClusterMessage

  object StatusUpdate {
    /** Alternate factory method that takes a ByteBuffer directly for the data field */
    def apply(executorId: String, taskId: Long, state: TaskState, data: ByteBuffer, time: Long, taskSize: Long, fetchSize: Long)
      : StatusUpdate = {
      StatusUpdate(executorId, taskId, state, new SerializableBuffer(data), time: Long, taskSize: Long, fetchSize: Long)
    }
  }
