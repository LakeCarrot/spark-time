...
private[spark] class CoarseGrainedExecutorBackend(
  ...
  override def statusUpdate(taskId: Long, state: TaskState, data: ByteBuffer, time: Long, taskSize: Long, fetchSize: Long) {
    val msg = StatusUpdate(executorId, taskId, state, data, time, taskSize, fetchSize)
    driver match {
